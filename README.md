...
# .
# dependencias que podem ser necessarias na config com waybar 
...
# Configuração de teclado para ABNT2
1. Usando o localectl
...
# Configurar arquivo config.conf do mangowm
2.  No arquivo de configuração (config.conf) 
...
# configurar arquivo .bash_profile
